...
-   **[<u>Fae</u>](https://docs.google.com/document/d/1R-0k59PQcGkuKDj-tdcE6xInMSFnFtqk5I3Jo5ZfSkQ/edit?usp=sharing)
    > \[Stub\]**
...
-   **Directional Language**: While not a true language in itself, a
    ...
    > and dialects that would fit as “close enough” with anybody living
    > in the respective Cardinal Directions (Air, Water, Fire, Wood).
    > This
...
-   Need to get all the Types of Charms organized. What does a Secondary
    > Action mean, etc.
...
-   Sizes and their bonuses (will be with Lunars/Mutations):
    ...
    -   **Gigantic** +4 Soak, No Fine Dexterity/Sneak, -2 Evasion, +10
        > End
